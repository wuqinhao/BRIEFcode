...
protected:
	...
	double cal_threshold(Mat image, int channel);
};
...
double BRIEF::cal_threshold(Mat image, int channel)
{
	int r = image.rows;
	int c = image.cols;
	...
	Mat g = gaussian_kernel(1, channel); //calculate the gaussian kernal
